...
int main() {
	...
	cout << "(\"py : \" + pystr).capitalize : "p.ljust(32) << ("py : " + str).capitalize() << endl;
	cout << "pystr.casefold : "p.ljust(32) << str.casefold() << endl;
	...
	cout << "pystr.isdigit() : "p.ljust(32) << str.isdigit() << endl;
	cout << "pystr.isdecimal() : "p.ljust(32) << str.isdecimal() << endl;
	cout << "pystr.islower() : "p.ljust(32) << str.islower() << endl;
	cout << "pystr.isnumeric() : "p.ljust(32) << str.isnumeric() << endl;
	cout << "pystr.isprintable() : "p.ljust(32) << str.isprintable() << endl;
	cout << "pystr.isspace() : "p.ljust(32) << str.isspace() << endl;
	cout << "pystr.istitle() : "p.ljust(32) << str.istitle() << endl;
	cout << "pystr.isupper() : "p.ljust(32) << str.isupper() << endl;
	...
	cout << "pystr.lower() : "p.ljust(32) << str.lower() << endl;
	...
	cout << "pystr.swapcase() : "p.ljust(32) << str.swapcase() << endl;
	cout << "pystr.title() : "p.ljust(32) << str.title() << endl;
	cout << "pystr.upper() : "p.ljust(32) << str.upper() << endl;
